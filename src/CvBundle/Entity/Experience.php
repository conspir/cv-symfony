...
class Experience
{
    ...
    /**
     * @var Mission[]
     * @ORM\OneToMany(targetEntity="CvBundle\Entity\Mission", mappedBy="experience", cascade={"persist","merge","remove"})
     */
    private $mission;
     ...
     * Add mission
     *
     * @param \CvBundle\Entity\Mission $mission
     *
     * @return Experience
     */
    public function addMission(\CvBundle\Entity\Mission $mission) {
     ...
     * @param \CvBundle\Entity\Mission $mission
     */
    public function removeMission(\CvBundle\Entity\Mission $mission) {
